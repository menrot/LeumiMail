...
def extractPdfText(filePath=''):
    ...
    if (text == ''):
        ...
        text = textract.process(filePath, method='tesseract', encoding='utf-8', language = heb)
...
if __name__ == '__main__':
    pdfFilePath = 'D:\\Users\\Menashe\\mG Drive\\My Projects\\LeumiMail\\temp\\Downloaded\\1193184010_2006613623189.PDF'
